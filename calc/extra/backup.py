...
def handle_punches(blue_punches,red_punches,Rpunch_location,Bpunch_location,onion,cookie,Rhand,Bhand,Rfist,Bfist):
...
def main(fps,Red_ghost,Blue_ghost,red,blue):
    ...
    while fps==60:
        ...
        onion,cookie=handle_punches(Blue_punches,Red_punches,Rpunch_location,Bpunch_location,onion,cookie,Rhand,Bhand,Rfist,Bfist)
