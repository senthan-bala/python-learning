...
def draw_screen(
    red_racket, blue_racket, ball, sped, rsped, dir_num, x, y, r_score, b_score
):
...
def main():
    ...
    while not_dead:
        ...
        x, y, racket_sped, sped = handle_balls(
            red_racket, blue_racket, ball, x, y, sped, racket_sped
        )
        racket_movement(red_racket, blue_racket, keys, racket_length, racket_sped)
        sped, racket_sped, x, y, red_score, blue_score = draw_screen(
            red_racket,
            blue_racket,
            ball,
            sped,
