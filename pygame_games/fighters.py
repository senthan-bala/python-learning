...
ghost_width = 100
ghost_sped = 5
redx = width - width + 1.5 * ghost_width
redy = height - ghost_height
bluex = width - ghost_width - 1.5 * ghost_width
...
# incorrect_sound = pygame.mixer.Sound(
# os.path.join("pygame_stuff", "incorrect_sound.mp3")
# )
...
def draw(
    ...
    pygame.draw.polygon(
        window, (200, 200, 200), ((0, 300), (0, 500), (150, 500), (150, 450))
    )
    pygame.draw.polygon(
        window, (200, 200, 200), ((900, 300), (900, 500), (750, 500), (750, 450))
    )
...
def ghost_moving(
    ...
    if keys[pygame.K_UP]:
        ...
        for i in range(ghost_height):
            ...
            banana = ghost_moving_backup(
                red, blue, keys, ghost_w, rev_col, potato, banana
            )
            flip = draw(
                red,
                blue,
...
def main(fps, Red_ghost, Blue_ghost, red, blue):
    ...
    while fps == 60:
        ...
        Rhand = pygame.Rect(100, 100, 1, 1)
        Bhand = pygame.Rect(100, 100, 1, 1)
        Rfist = pygame.Rect(100, 100, 1, 1)
        Bfist = pygame.Rect(100, 100, 1, 1)
        if flip == 0:
            # if onion>-1:
            Bx = blue.x - 24
            By = blue.y + 55
